    ...
    return (
      <Card className={classes['portal-annual-performance-widget']}>
        <CardHeader
          ...
          subheader="Ventas por cuota de mercado"
        />
        ...
        >
          <MenuItem key={1} onClick={this.onItemClick}>Diaria</MenuItem>
          <MenuItem key={2} onClick={this.onItemClick}>Anual</MenuItem>
          <MenuItem key={3} onClick={this.onItemClick}>Mensual</MenuItem>
          <MenuItem key={4} onClick={this.onItemClick}>Semanal</MenuItem>
        </Menu>
      </Card>
    );
  }
