    ...
    return (
      <Card className={classes['portal-market-cap-widget']}>
        <CardHeader
          ...
          subheader="10 productos con mayor cuota de mercado"
        />
        <CardContent className={classes['portal-market-cap-widget__table']}>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell className={classes['table-cell']}>Lugar</TableCell>
                ...
                <TableCell className={classes['table-cell']} numeric>Promedio unitario</TableCell>
                <TableCell className={classes['table-cell']} numeric>Cambio</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map(item => (
