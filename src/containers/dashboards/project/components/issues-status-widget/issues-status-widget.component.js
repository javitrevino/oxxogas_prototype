    ...
    return (
      <Card className={classes['portal-issues-status-widget']}>
        <CardHeader
          ...
          title={issuesTitle}
          subheader="Junio 2018 - Julio 2018"
        />
        ...
        >
          <MenuItem key={1} onClick={() => this.onItemClick('Vista Diaria')}>Día</MenuItem>
          <MenuItem key={2} onClick={() => this.onItemClick('Vista Semanal')}>Semana</MenuItem>
          <MenuItem key={3} onClick={() => this.onItemClick('Vista Mensual')}>Mes</MenuItem>
        </Menu>
      </Card>
    );
  }
