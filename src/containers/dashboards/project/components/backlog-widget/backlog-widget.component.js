          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell className={classes['table-cell']}>Pendiente</TableCell>
                <TableCell className={classes['table-cell']} numeric>Tiempo estimado</TableCell>
                <TableCell className={classes['table-cell']} numeric>Status</TableCell>
                <TableCell className={classes['table-cell']} numeric>Prioridad</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map(item => {
